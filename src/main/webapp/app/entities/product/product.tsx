            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('price')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('size')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.size">Size</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('image')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.product.image">Image</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{product.price}</td>
                  <td>
                    <Translate contentKey={`jhipsterSampleApplicationApp.Size.${product.size}`} />
                  </td>
                  <td>
                    {product.image ? (
                      <div>
