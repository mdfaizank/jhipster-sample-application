            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="sizeLabel" for="product-size">
                  <Translate contentKey="jhipsterSampleApplicationApp.product.size">Size</Translate>
                </Label>
                <AvInput id="product-size" type="select" className="form-control" name="size" value={(!isNew && productEntity.size) || 'S'}>
                  <option value="S">{translate('jhipsterSampleApplicationApp.Size.S')}</option>
                  <option value="M">{translate('jhipsterSampleApplicationApp.Size.M')}</option>
                  <option value="L">{translate('jhipsterSampleApplicationApp.Size.L')}</option>
                  <option value="XL">{translate('jhipsterSampleApplicationApp.Size.XL')}</option>
                  <option value="XXL">{translate('jhipsterSampleApplicationApp.Size.XXL')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <AvGroup>
                  <Label id="imageLabel" for="image">
                    <Translate contentKey="jhipsterSampleApplicationApp.product.image">Image</Translate>
                  </Label>
                  <br />
                  {image ? (
                    <div>
              ...
              <AvGroup>
                <Label for="product-productCategory">
                  <Translate contentKey="jhipsterSampleApplicationApp.product.productCategory">Product Category</Translate>
                </Label>
