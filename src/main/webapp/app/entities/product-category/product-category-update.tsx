  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.productCategory.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.productCategory.home.createOrEditLabel">
