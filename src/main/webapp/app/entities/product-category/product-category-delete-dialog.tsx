...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.productCategory.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
