  ...
  return (
    <div>
      <h2 id="product-category-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.productCategory.home.title">Product Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.productCategory.home.createLabel">Create new Product Category</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('jhipsterSampleApplicationApp.productCategory.home.search')}
                />
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.productCategory.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.productCategory.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.productCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )
        )}
      </div>
