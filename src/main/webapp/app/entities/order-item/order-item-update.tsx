  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.orderItem.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : orderItemEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="statusLabel" for="order-item-status">
                  <Translate contentKey="jhipsterSampleApplicationApp.orderItem.status">Status</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="AVAILABLE">{translate('jhipsterSampleApplicationApp.OrderItemStatus.AVAILABLE')}</option>
                  <option value="OUT_OF_STOCK">{translate('jhipsterSampleApplicationApp.OrderItemStatus.OUT_OF_STOCK')}</option>
                  <option value="BACK_ORDER">{translate('jhipsterSampleApplicationApp.OrderItemStatus.BACK_ORDER')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="order-item-product">
                  <Translate contentKey="jhipsterSampleApplicationApp.orderItem.product">Product</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label for="order-item-order">
                  <Translate contentKey="jhipsterSampleApplicationApp.orderItem.order">Order</Translate>
                </Label>
                <AvInput
                  id="order-item-order"
                  type="select"
