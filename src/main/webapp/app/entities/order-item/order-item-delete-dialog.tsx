...
export const OrderItemDeleteDialog = (props: IOrderItemDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.orderItem.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
