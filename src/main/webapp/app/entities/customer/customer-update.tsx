            ...
            <AvForm model={isNew ? {} : customerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="genderLabel" for="customer-gender">
                  <Translate contentKey="jhipsterSampleApplicationApp.customer.gender">Gender</Translate>
                </Label>
                <AvInput
                  id="customer-gender"
                  type="select"
                ...
                >
                  <option value="MALE">{translate('jhipsterSampleApplicationApp.Gender.MALE')}</option>
                  <option value="FEMALE">{translate('jhipsterSampleApplicationApp.Gender.FEMALE')}</option>
                  <option value="OTHER">{translate('jhipsterSampleApplicationApp.Gender.OTHER')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="cityLabel" for="customer-city">
                  <Translate contentKey="jhipsterSampleApplicationApp.customer.city">City</Translate>
                </Label>
                <AvField
                  id="customer-city"
                  type="text"
              ...
              <AvGroup>
                <Label id="countryLabel" for="customer-country">
                  <Translate contentKey="jhipsterSampleApplicationApp.customer.country">Country</Translate>
                </Label>
                <AvField
                  id="customer-country"
                  type="text"
              ...
              <AvGroup>
                <Label for="customer-user">
                  <Translate contentKey="jhipsterSampleApplicationApp.customer.user">User</Translate>
                </Label>
                <AvInput
                  id="customer-user"
                  type="select"
