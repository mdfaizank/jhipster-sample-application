...
export const ProductOrderDeleteDialog = (props: IProductOrderDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.productOrder.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
