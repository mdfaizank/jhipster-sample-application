  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.productOrder.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.productOrder.home.createOrEditLabel">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : productOrderEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="COMPLETED">{translate('jhipsterSampleApplicationApp.OrderStatus.COMPLETED')}</option>
                  <option value="PENDING">{translate('jhipsterSampleApplicationApp.OrderStatus.PENDING')}</option>
                  <option value="CANCELLED">{translate('jhipsterSampleApplicationApp.OrderStatus.CANCELLED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="codeLabel" for="product-order-code">
                  <Translate contentKey="jhipsterSampleApplicationApp.productOrder.code">Code</Translate>
                </Label>
                <AvField
